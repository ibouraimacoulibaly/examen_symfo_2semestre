...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commentaires = $em->getRepository('BlogBlogBundle:Commentaire')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Blog\BlogBundle\Form\CommentaireType', $commentaire);
    ...
    {
        $deleteForm = $this->createDeleteForm($commentaire);
        $editForm = $this->createForm('Blog\BlogBundle\Form\CommentaireType', $commentaire);
